        ...
        <div className='popup-wrapper priority'>
            ...
            <div className='about'>
                <div className='sub-title'>
                    <em>Personalized Memories</em> is an interactive, non-linear storytelling experience by <a href='https://www.katiewhan.com/' target='_blank' rel='noopener noreferrer'>Katie Han</a>. 
