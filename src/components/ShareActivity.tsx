    ...
    renderContents() {
        switch (this.props.type) {
            ...
            case ShareActivityType.Location:
                return (
                    <div className='share-content-wrapper'>
                        <img className='share-content-3' src='assets/images/share-loc-1.jpg' alt='view of driving by water'></img>
                        <img className='share-content-3' src='assets/images/share-loc-2.jpg' alt='woman by the beach'></img>
                        <img className='share-content-3' src='assets/images/share-loc-3.jpg' alt='view of the beach'></img>
                    </div>
                );
        }
    }
